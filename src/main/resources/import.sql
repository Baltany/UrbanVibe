...
INSERT INTO `user` (`name`, `username`, `surname`, `mail`, `password`, `address`, `dni`,`enable`) VALUES ('Balbino', 'balbino', 'Moyano', 'mail@gmail.com', '$2a$10$PMDCjYqXJxGsVlnve1t9Jug2DkDDckvUDl8.vF4Dc6yg0FMjovsXO', 'Calle montoro 6', '50624970s',1);
